package com.hexing.pullRefrushView;
...
/**
 * 下来刷新控件。在其里面放入listView或者GridView，就可以实现下拉刷新
 * 有两个方法和两个监听器供调用：1，onHeaderRefreshComplete，2，onFooterRefreshComplete
 * 3，setOnHeaderRefreshListener，4，setOnFooterRefreshListener
 * 
 * @author hexing
 * 
 */
public class PullToRefreshView extends LinearLayout {
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderImageView.setImageResource(R.drawable.pulltorefresh);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
