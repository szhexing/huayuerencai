 ...
 * also scrolled.
 */
public class HX_TitlePageIndicator extends View implements PageIndicator {
    /**
    ...
    public HX_TitlePageIndicator(Context context) {
        this(context, null);
    }

    public HX_TitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.vpiTitlePageIndicatorStyle);
    }

    public HX_TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
